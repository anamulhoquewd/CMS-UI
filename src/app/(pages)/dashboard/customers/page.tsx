...
import { customersColumns } from "@/components/customer/column";
import CustomTable from "@/components/customer/table";
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Card className="w-full overflow-hidden">
        ...
        <CardContent>
          <CustomTable table={table} columns={columns} users={customers} />
        </CardContent>
      </Card>
    </div>
  );
